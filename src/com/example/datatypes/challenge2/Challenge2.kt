package com.example.datatypes.challenge2
...
fun main(args: Array<String>) {
    ...
    /*2. Now change one of those variable declarations into nullable variable*/
    val float1N: Float? = -3847.384f

    /*3. Now declare an array of type non-nullable Short. Make it size 5, and assign it the values 1, 2, 3, 4, 5*/
    val shortArray: Array<Short> = arrayOf(1, 2, 3, 4, 5)
    val shortArray2 = shortArrayOf(1, 2, 3, 4, 5)

    /*4. Now declare an array of nullable Ints and initialize it with the values 5, 10, 15, etc. all the way up to 200*/
    val nullableIntsArray: Array<Int?> = Array(40) { i -> (i + 1) * 5 }
    //val nullableIntsArray1: Array<Int?>(40) { i -> (i + 1) * 5 } //shorter declaration and assignment
    ...
    */
    ...
    Challenge2Java.method1(charArray)
    ...
    */
    ...
    myNonNullVariable!!.toDouble(); //shot :)
}